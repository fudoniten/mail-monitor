...
```nix
{
  inputs = {
    ...
    mail-monitor.url = "github:fudoniten/mail-monitor";
  };

  outputs = { self, nixpkgs, mail-monitor, ... }: {
    nixosConfigurations.your-host = nixpkgs.lib.nixosSystem {
      modules = [
        mail-monitor.nixosModules.default
        {
...
```bash
# Run once
nix run github:fudoniten/mail-monitor -- \
  --smtp-host mail.example.com \
  --imap-host mail.example.com \
  --username monitor@example.com \
...
# Or install it
nix profile install github:fudoniten/mail-monitor
...
Issues and pull requests welcome at https://github.com/fudoniten/mail-monitor
